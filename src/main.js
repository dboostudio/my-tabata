...
function saveMinimalistMode(enabled) {
    try {
        if (enabled) {
...
function markPwaInstallDismissed() {
    try {
...
try {
    ...
    document.querySelector('#overall-progress')?.style.setProperty('display', 'none');
